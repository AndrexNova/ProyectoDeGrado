...
public function __construct($total, $limit_numrows, $from, $Parameters){
    ...
    if ($this->_numberPages > MAX_NUM_BOXES){
        ...
        $more = "<a class='btn btn-primary' title='{$title}' data-container='body' data-placement='right' data-toggle='popover' href='#' data-html='true' data-content=\"{$links}\">Ir a</a>\n";
    }
