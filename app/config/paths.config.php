...
$PATH_CONFIG["TRAGRA_ANTEPROYECTO"] = $PATH_CONFIG["WEBFILES"]."/trabajosgrado/anteproyectos";
...
$PATH_CONFIG["HOMOLOGACION"]        = $PATH_CONFIG["ROOT"]["modules"]."/homologaciones/views";
